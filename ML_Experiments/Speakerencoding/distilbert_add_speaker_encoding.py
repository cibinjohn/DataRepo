# -*- coding: utf-8 -*-
"""distilbert add speaker encoding.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1L39ZATNFznspIfUSdiOIOoqMVTaMXF-u
"""

ls drive/MyDrive/exl/data
...
def add_speaker_info(text):
  ...
  for chunk in text.split("\n\n"):
    ...
    current_speaker = lines[0].split(" ")[0].split(":")[0]
...
with open("drive/MyDrive/exl/data/speaker_encoding_v3/train.txt",'w+') as f:
  f.write(transformed_train_data)

with open("drive/MyDrive/exl/data/speaker_encoding_v3/test.txt",'w+') as f:
  f.write(transformed_test_data)
...
#     def __init__(self, guid, words, labels, speaker_ids):
#         self.guid = guid
#         self.words = words
#         self.labels = labels
...
"""# Custom Model with Speaker Embeddings"""
class DistilBertForTokenClassificationWithSpeaker(DistilBertForTokenClassification):
    ...
    def __init__(self, config, num_speakers=3):
        ...
        self.speaker_embeddings = torch.nn.Embedding(
            num_speakers,
            config.dim  # DistilBERT hidden size
        )
    ...
    def forward(
        ...
        **kwargs
        ...
        if speaker_ids is not None:
            ...
            sequence_output = sequence_output + speaker_embeds
...
class DistilBertNERTraining:
    ...
    def _read_examples_from_file(self, file_path: str, mode: str = "train") -> List[InputExample]:
        ...
        """
        # print(" _read_examples_from_file start")
        examples = []
        guid_index = 1
...
trainer = DistilBertNERTraining(
    labels=labels,
    model_save_dir="drive/MyDrive/exl/model/SE",
    config=config
)
...
trainer.train(
    train_file="drive/MyDrive/exl/data/speaker_encoding/train.txt"
